...
> 15 原子组的别名(?<link>reg),利用reg的exec方法会在返回内容里包含groups:{link:''},可以利用此来获取别名组匹配到的内容，如下图所示：

![image](https://user-images.githubusercontent.com/31762176/223952113-cc96af5b-d215-43b8-8239-e1c0d85c250e.png)
